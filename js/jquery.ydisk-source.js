...
;(function(window, document, $) {
    ...
    // AUTOLOAD CODE BLOCK (MAY BE CHANGED OR REMOVED TO OTHER PLASE)
    $(document).ready(function() {
        
        var ydiskPlay = function(id, type) {
                //в эту функцию передаются id заданное новому вставляемомоу элементу и контент тайп audio,image,video пока только эти доступны
